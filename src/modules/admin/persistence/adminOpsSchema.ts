...
export const adminPrompts = pgTable('admin_prompts', {
  ...
  contextWindow: text('context_window').notNull().default('default'),
  schemaId: text('schema_id'),
  activeVersion: text('active_version').notNull().default('1'),
  avgLatencyMs: text('avg_latency_ms').notNull().default('0'),
  avgCostUsd: text('avg_cost_usd').notNull().default('0'),
  successRate: text('success_rate').notNull().default('0'),
  totalRuns: text('total_runs').notNull().default('0'),
